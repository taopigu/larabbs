          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Topic_id</th> <th>User_id</th> <th>Is_block</th> <th>Vote_count</th> <th>Body</th> <th>Body_original</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$reply->topic_id}}</td> <td>{{$reply->user_id}}</td> <td>{{$reply->is_block}}</td> <td>{{$reply->vote_count}}</td> <td>{{$reply->body}}</td> <td>{{$reply->body_original}}</td>
